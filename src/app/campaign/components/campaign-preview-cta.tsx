        ...
        <AnimatePresence initial={false}>
            {(canPreview || isWaitingForMedia) && (
                <motion.div
                    ...
                    className="rounded-2xl border border-slate-200 bg-[linear-gradient(135deg,#ffffff_0%,#f7faff_100%)] p-4 shadow-sm sm:p-5"
                >
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        {canPreview ? (
                            <AdPreviewButton
                                ad={ad}
                                title={title}
                                className="h-auto w-full border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 hover:border-slate-300 hover:bg-slate-50 sm:w-auto"
                            />
                        ) : (
                            <div
                                className="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-100 px-4 py-3 text-sm font-medium text-slate-500">
